        ...
        <div class="col-lg-6">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form action="{{ route('patient.update', $patient->id) }}" method="post" id="formPatient">
                        @csrf
                        @method('PATCH')

                        <div class="form-group">
                            <label>Nomor Registrasi</label>
                            <input type="text" name="registration_number" class="form-control" value="{{ $patient->registration_number }}" readonly required>
                        </div>
                        <div class="form-group">
                            <label>Nama Lengkap</label>
                            <input type="text" class="form-control" name="name" id="name" required value="{{ $patient->name }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone_number" id="phone_number" required value="{{ $patient->phone_number }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="type_identity" id="type_identity" class="form-control" required>
                                        @if($patient->type_identity == 'KTP')
                                        <option value="KTP" selected>KTP</option>
                                        <option value="SIM">SIM</option>
                                        <option value="Kartu Pelajar">Kartu Pelajar</option>
                                        @elseif($patient->type_identity == 'SIM')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="no_identity" id="no_identity" required value="{{ $patient->no_identity }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="blood_type" id="blood_type" class="form-control" required>
                                        ...
                                        @elseif($patient->blood_type == 'B')
                                        <option value="O">O</option>
                                        <option value="A">A</option>
                                        <option value="B" selected>B</option>
                                        <option value="AB">AB</option>
                                        @elseif($patient->blood_type == 'AB')
                                        <option value="O">O</option>
                                        <option value="A">A</option>
                                        <option value="B">B</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" id="address" required cols="30" rows="2" class="form-control">{{ $patient->address }}</textarea>
                            <small class="text-danger" id="address_error"></small>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group row">
                            <div class="col-sm-12 col-sm-offset-2">
                                <button class="btn btn-primary float-right" type="submit"><i class="fa fa-edit"></i> Ubah</button>
                            </div>
                        </div>
                    </form>
                </div>
