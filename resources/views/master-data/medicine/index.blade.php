        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5><button class="btn btn-primary btn-sm" data-toggle="modal" data-mode="add" data-target="#ModalAddEdit"><i class="fa fa-plus-square mr-1"></i> Tambah Obat [F2]</button></h5>
                </div>
            ...
            <form id="formAddEdit" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group" style="margin-top: -10px;">
                        ...
                        <input type="text" class="form-control" id="code" name="code" tabindex="1" required maxlength="200" readonly>
    ...
    $(document).ready(function() {
        ...
        $('#ModalAddEdit').on('shown.bs.modal', function(e) {
            ...
            if (button.data('mode') == 'edit') {
                ...
                $('#formAddEdit').attr('action', '{{ route("medicine.store") }}/' + id).attr('method', 'PATCH')

                modal.find('#modal-title').text('Edit Obat');
                modal.find('#code').val(closeTr.find('td:eq(1)').text())
                modal.find('#name').val(closeTr.find('td:eq(2)').text())

            } else {
                $('#formAddEdit').trigger('reset').attr('action', '{{ route("medicine.store") }}').attr('method', 'POST')
                modal.find('#modal-title').text('Tambah Obat');
                modal.find('#code').val('{{ $medicine_code }}')
            }
        })
