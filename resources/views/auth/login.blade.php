...
<head>
    ...
    <title>Himed - High Medical Technology</title>
...
<body class="gray-bg">
    ...
    <div class="passwordBox animated fadeInDown">
        <div class="row">
            <div class="col-md-12">
                <div class="ibox-content">
                    ...
                    <p class="m-t ">
                        <small>We App Supported by &bullet; <a target="_blank" href="https://www.uinjkt.ac.id/">UIN Jakarta</a></small>
                    </p>
        ...
        <div class="row">
            <div class="col-md-12">
                &copy; <small>{{ date('Y') }} &bullet; Himed - High Medical Technology</small>
            </div>
